...
import com.projetos.cursomc.domain.Endereco;
import com.projetos.cursomc.domain.Estado;
import com.projetos.cursomc.domain.ItemPedido;
import com.projetos.cursomc.domain.Pagamento;
import com.projetos.cursomc.domain.PagamentoComBoleto;
import com.projetos.cursomc.domain.PagamentoComCartao;
import com.projetos.cursomc.domain.Pedido;
import com.projetos.cursomc.domain.Produto;
import com.projetos.cursomc.domain.enums.EstadoPagamento;
import com.projetos.cursomc.domain.enums.TipoCliente;
import com.projetos.cursomc.repositories.CategoriaRepository;
import com.projetos.cursomc.repositories.CidadeRepository;
import com.projetos.cursomc.repositories.ClienteRepository;
import com.projetos.cursomc.repositories.EnderecoRepository;
import com.projetos.cursomc.repositories.EstadoRepository;
import com.projetos.cursomc.repositories.ItemPedidoRepository;
import com.projetos.cursomc.repositories.PagamentoRepository;
...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "363738398741", TipoCliente.PESSOAFISICA);
		cli1.getTelefone().addAll(Arrays.asList("27363323", "93838393"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "1056", "Sala 800", "Centro", "38777012", cli1, c2);
